...
class GeneratePDF {
  ...
  String _getValueIndex(int row, int col) {
    ...
    switch (col) {
      case 0:
        return
          utf8convert(snapshot["itensRelatorio"][row]["proposta"]["nomeProjeto"].toString());
      case 1:
        return
          utf8convert(snapshot["itensRelatorio"][row]["classificacao"].toString());
      case 2:
        return utf8convert(snapshot["itensRelatorio"][row]["proposta"]["subPDC"]["titulo"].toString());
      case 3:
        return
          utf8convert(snapshot["itensRelatorio"][row]["classificacaoSubpdc"].toString());
      case 4:
        return
          utf8convert(snapshot["itensRelatorio"][row]["soma"].toString());
    }
    return '';
  }
